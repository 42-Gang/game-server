...
describe('TournamentMatchCache', () => {
  ...
  describe('createMatch & getMatchesInRound', () => {
    it('should add a single match to the correct round set', async () => {
      const matchData: MatchLike = { id: 101, round: 1 };
    ...
    it('getMatchesInRound should return all match IDs in the given round', async () => {
      ...
      await cache.createMatch(tournamentId, 201, { id: 201, round: 2 } as any);
      await cache.createMatch(tournamentId, 202, { id: 202, round: 2 } as any);
      await cache.createMatch(tournamentId, 301, { id: 301, round: 3 } as any);
    ...
    it('should isolate matches between different tournaments', async () => {
      ...
      await cache.createMatch(1, 401, { id: 401, round: 4 } as any);
      // tournamentId=2에도 같은 matchId를 같은 라운드로 추가
      await cache.createMatch(2, 401, { id: 401, round: 4 } as any);
